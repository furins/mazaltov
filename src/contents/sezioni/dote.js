                            ...
                            <div className="inverted container--page mostra">
                                ...
                                <div className="">{/* inserire qui il testo */}
                                    ...
                                    <div className="pure-g">
                                        <div className="pure-u-1 pure-u-md-11-24">
                                            {visibile2 ? <Lightbox
                                                image={require("../../images/full/dote/foto_03.jpg").default}
                                                title="KETUBBAH"
                                                onClose={() => { setVisibile2(false) }}
                                            /> : null}
                                            <img
                                                src={require("../../images/thumbs/dote/foto_03.jpg").default}
                                                alt="KETUBBAH"
                                                className="responsive"
                                        ...
                                        <div className="pure-u-1 pure-u-md-1-2">
                                            ...
                                            <div className="didascalia--descrizione">
                                                Nozze di Izchak di Isacchia Ajò con Fortunata di Benedetto Bachis, 8 marcheshvan
